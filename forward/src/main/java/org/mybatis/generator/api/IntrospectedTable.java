...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setMyBatis3JavaMapperType(calculateMyBatis3JavaMapperType());
        ...
        setSelectByPrimaryKeyStatementId(""); //$NON-NLS-1$
     ...
     * @return
     */
    protected String calculateSqlMapperInterfacePackage() {
        StringBuilder sb = new StringBuilder();
        SqlMapGeneratorConfiguration config = context
                .getSqlMapGeneratorConfiguration();

        if (config != null) {
            String mapperInterfacePackage = config.getProperty("mapperInterfacePackage");
            sb.append(mapperInterfacePackage);
        }
    ...
    protected String calculateMyBatis3JavaMapperType() {
        StringBuilder sb = new StringBuilder();
        sb.append(calculateSqlMapperInterfacePackage());
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("Mapper"); //$NON-NLS-1$
        return sb.toString();
